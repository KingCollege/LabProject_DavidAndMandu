    ...
    <body>
        ...
        <div class ="accessibleFeature">
            ...
            <div id="add">
                ...
                <tr>
                <td><h6>Today's Date:</h6><input required readonly class = "input" type="date" value = <?php echo "\"".date("Y/m/d")."\"" ;?> name ="rentedD" /></td>
                <td><h6>Date Due:</h6><input required readonly class = "input" type="date"
